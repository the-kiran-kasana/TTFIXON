...
const statCards = [
  { l:'Total Withdrawn', v:'₹39,150', Icon:ArrowDownToLine, color:'#6366f1', bg:'#eef2ff' },
  { l:'Pending Payouts', v:'₹17,800', Icon:Clock,           color:'#f59e0b', bg:'#fffbeb' },
  { l:'Completed Today', v:'2',       Icon:CheckCircle,     color:'#10b981', bg:'#ecfdf5' },
  { l:'Failed',          v:'1',       Icon:XCircle,         color:'#ef4444', bg:'#fef2f2' },
];
              ...
              {filtered.map((w, i) => (
                <tr key={w.id} style={{ borderBottom:'1px solid #f8fafc', background:i%2===0?'#fff':'#fafafa' }}>
                  ...
                  <td style={{ padding:'12px' }}>
                    <span style={{ background:statusStyle[w.status].bg, color:statusStyle[w.status].color, padding:'3px 10px', borderRadius:'999px', fontSize:'12px', fontWeight:'600' }}>
                      {w.status}
                    </span>
                  </td>
                  <td style={{ padding:'12px' }}>
