"use client";
import { TrendingUp, TrendingDown, Lightbulb, BarChart2, Users, MapPin, Bot } from "lucide-react";

const kpis = [
  { label: "Revenue Growth",       value: "+12.5%", trend: "up", sub: "vs last month",       color: "#10b981", bg: "#f0fdf4", icon: <TrendingUp size={28} color="#10b981" /> },
  { label: "Booking Growth",       value: "+8.3%",  trend: "up", sub: "vs last month",       color: "#6366f1", bg: "#eef2ff", icon: <BarChart2  size={28} color="#6366f1" /> },
  { label: "Customer Retention",   value: "78%",    trend: "up", sub: "industry avg 65%",    color: "#f59e0b", bg: "#fffbeb", icon: <Users     size={28} color="#f59e0b" /> },
  { label: "Provider Utilization", value: "82%",    trend: "up", sub: "+5% vs last quarter", color: "#3b82f6", bg: "#eff6ff", icon: <MapPin    size={28} color="#3b82f6" /> },
];
...
const insights = [
  { Icon: Bot,        title: "Demand Surge Expected", desc: "Cleaning services demand predicted to rise 35% next weekend based on seasonal trends.", color: "#eef2ff", border: "#c7d2fe" },
  { Icon: TrendingDown, title: "Churn Risk Alert",   desc: "42 customers haven't booked in 90+ days. Consider sending a re-engagement offer.",       color: "#fff7ed", border: "#fed7aa" },
  { Icon: Lightbulb,  title: "Pricing Opportunity",  desc: "Electrical services in Bangalore are underpriced by ~18% compared to market benchmarks.", color: "#f0fdf4", border: "#bbf7d0" },
];
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16 }}>
          {insights.map((ins) => (
            <div key={ins.title} style={{ background: ins.color, border: `1px solid ${ins.border}`, borderRadius: 10, padding: 20 }}>
              <div style={{ marginBottom: 10 }}><ins.Icon size={28} color="#64748b" /></div>
